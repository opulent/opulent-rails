          ...
          ActiveSupport.on_load(:after_initialize) do
            begin
              if defined?(CacheDigests::DependencyTracker)
                ...
                CacheDigests::DependencyTracker.register_tracker :opulent, CacheDigests::DependencyTracker::ERBTracker
                ...
                ActionView::DependencyTracker.register_tracker :opulent, ActionView::DependencyTracker::ERBTracker
